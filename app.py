...
# Title and Logo
st.image('BIA.png', width=450, caption="BIA ScholarVerify™")
st.title("BIA ScholarVerify™")
...
if not st.session_state.submitted:
    with st.form("student_info"):
        ...
        institution = st.selectbox(
            ...
            ["BIA Kottayam", "BIA Trivandrum"],
            key="institution_input"
        )
        
        if st.form_submit_button("Login"):
            if student_name and institution:
...
if st.session_state.submitted:
    ...
    st.markdown("### BIA Assignment Verification application by Rohit Krishnan")
